...
from streaming_availability._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(sync: bool, client: StreamingAvailability, async_client: AsyncStreamingAvailability) -> None:
...
async def test_data_missing_event(
    sync: bool, client: StreamingAvailability, async_client: AsyncStreamingAvailability
) -> None:
    def body() -> Iterator[bytes]:
        yield b'data: {"foo":true}\n'
        yield b"\n"
