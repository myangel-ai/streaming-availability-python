# Streaming Availability Python API library

[![PyPI version](https://img.shields.io/pypi/v/streaming_availability.svg)](https://pypi.org/project/streaming_availability/)

The Streaming Availability Python library provides convenient access to the Streaming Availability REST API from any Python 3.7+
...
You can enable logging by setting the environment variable `STREAMING_AVAILABILITY_LOG` to `debug`.

```shell
$ export STREAMING_AVAILABILITY_LOG=debug
```
